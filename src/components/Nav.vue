<template>
  ...
  <ul class="nav">
    ...
    <li>
      <a href class="auto">
        <span class="pull-right text-muted"> <i class="fa fa-fw fa-angle-right text"></i> <i class="fa fa-fw fa-angle-down text-active"></i>
        </span>
      ...
      <ul class="nav nav-sub dk">
        ...
        <li ui-sref-active="active">
          <a ui-sref="app.dashboard-v2"> <b class="label bg-info pull-right">N</b>
    ...
    <li ui-sref-active="active">
      <a ui-sref="app.mail.list"> <b class="badge bg-info pull-right">9</b>
    ...
    <li ui-sref-active="active">
      <a ui-sref="app.echart">
        <i class="glyphicon glyphicon-signal"></i>
        <span translate="aside.nav.components.ECHART">EChart</span>
      </a>
    </li>
